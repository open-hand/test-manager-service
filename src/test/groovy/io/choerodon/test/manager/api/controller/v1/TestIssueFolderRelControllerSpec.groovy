...
//
//        when: '向issueFolderRel的插入创建接口发请求'
//        def entity2 = restTemplate.postForEntity('/v1/projects/{project_id}/issueFolderRel/testAndRelationship?folderId={folderId}&versionId={versionId}&applyType=test', issueCreateDTO2, TestIssueFolderRelVO, projectId, null, versionId)
//        then:
