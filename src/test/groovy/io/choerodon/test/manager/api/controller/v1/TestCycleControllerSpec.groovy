...
//        given:
//        Map map=new HashMap();
//        map.put(888L,new IssueInfosVO(issueId: 888L,issueNum: "num1",statusVO: new StatusVO(code: "code")))
//        map.put(44444442L,new IssueInfosVO(issueId: 44444442L,issueNum: "num2",statusVO: new StatusVO(code: "code")))
//        when:
...
//        0*testCaseService.getLinkIssueFromIssueToTest(_, _)>> Lists.newArrayList(new IssueInfosVO(issueId: 4443L))
...
//        Map map=new HashMap();
//        map.put(888L,new IssueInfosVO(issueId: 888L,issueNum: "num1",statusVO: new StatusVO(code: "code")))
//        map.put(889L,new IssueInfosVO(issueId: 889L,issueNum: "num2",statusVO: new StatusVO(code: "code")))
//        when:
...
//        map.put(888L,new IssueInfosVO(issueId: 888L,issueNum: "num1",statusVO: new StatusVO(code: "code")))
//        map.put(889L,new IssueInfosVO(issueId: 889L,issueNum: "num2",statusVO: new StatusVO(code: "code")))
//        TestCycleCaseDefectRelDTO defectRelDO=new TestCycleCaseDefectRelDTO();
...
////        given:
////        Map map=new HashMap();
////        map.put(884L,new IssueInfosVO(issueId: 884L,issueNum: "num1",statusVO: new StatusVO(code: "code")))
////        map.put(44444442L,new IssueInfosVO(issueId: 44444442L,issueNum: "num2",statusVO: new StatusVO(code: "code")))
////        TestCycleCaseDefectRelDTO defectRelDO1=new TestCycleCaseDefectRelDTO();
