...
//    def "Insert"() {
//        given:
//        TestStatusVO status = new TestStatusVO()
...
//        TestStatusVO status1 = new TestStatusVO()
//        def info = null
//
//        when: '向插入issues的接口发请求'
//        def entity = restTemplate.postForEntity('/v1/projects/{project_id}/status', status, TestStatusVO, projectId)
//        then:
...
//        when: '向插入issues的接口发请求'
//        try {
//            restTemplate.postForEntity('/v1/projects/{project_id}/status', status1, TestStatusVO, projectId)
//        } catch (Exception e) {
//            info = e
//        }
//
...
//
//        and: '设置值'
//        List<TestStatusVO> testStatusDTOS = entity.body
//
//        expect: '设置期望值'
...
//    def "Update"() {
//        given:
//        TestStatusVO statusNew = new TestStatusVO()
//        statusNew.setStatusId(statusId[0])
//        statusNew.setStatusType(TestStatusType.STATUS_TYPE_CASE)
...
//        TestStatusVO exceptionStatus = new TestStatusVO()
...
//
//        then: '返回值'
//        TestStatusDTO testStatusDO = testStatusMapper.selectByPrimaryKey(statusId[0])
//
//        expect: '验证更新是否成功'
//        testStatusDO.statusType == TestStatusType.STATUS_TYPE_CASE
...
//        when: '向修改issues的接口发请求'
//        try {
//            restTemplate.put('/v1/projects/{project_id}/status/update', TestStatusVO, exceptionStatus, projectId)
//        } catch (Exception e) {
//            info = e
//        }
//
