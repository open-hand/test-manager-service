...
class TestCaseServiceImplSpec extends Specification {
    ...
    def "GetIssueInfoMapAndPopulatePageInfo"() {
        ...
        1*testCaseFeignClient.listIssueWithLinkedIssues(_,_,_,_,_,_)>>
                new ResponseEntity<>(new Page(Lists.newArrayList(new IssueListTestWithSprintVersionDTO(issueId:1L,statusMapDTO: new StatusMapDTO(code: "code"))),new PageInfo(0,1,false),1),HttpStatus.OK)
    }
