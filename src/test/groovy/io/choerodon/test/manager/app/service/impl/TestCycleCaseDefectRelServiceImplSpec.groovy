...
//        given:
//        TestCycleCaseDefectRelVO defect1 = new TestCycleCaseDefectRelVO()
//        defect1.setIssueId(1L)
//        defect1.setDefectType(TestCycleCaseDefectCode.CYCLE_CASE)
//
...
//        TestCycleCaseDefectRelVO defect1 = new TestCycleCaseDefectRelVO()
//        defect1.setIssueId(1L)
//        defect1.setDefectType(TestCycleCaseDefectCode.CASE_STEP)
...
//        when:
//        vo.setDefects(Lists.newArrayList(new TestCycleCaseDefectRelVO(issueId: 1L)))
//        service.populateDefectAndIssue(vo, 144L, 1L)
//        then:
