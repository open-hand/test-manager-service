...
import io.choerodon.test.manager.api.dto.ExcelReadMeDTO;
 ...
 */
public class IReadMeExcelServiceImpl extends IAbstarctExcelServiceImpl<ExcelReadMeDTO, ExcelReadMeOptionDTO> {

    private Map<Integer, Row> rowMap = new HashMap<>();

    private Row firstRow;

    private ExcelReadMeDTO relReadMeDTO;
    ...
    @Override
    public int populateVersionHeader(Sheet sheet, String projectName, ExcelReadMeDTO readMeDTO, CellStyle rowStyle) {
    ...
    @Override
    public int populateHeader(Sheet sheet, int rowNum, ExcelReadMeDTO readMeDTO, CellStyle rowStyle) {
    ...
    @Override
    public int populateBody(Sheet sheet, int column, List<ExcelReadMeOptionDTO> readMeOptionDTOS, Queue<CellStyle> rowStyles) {
        int i = 1;
        for (ExcelReadMeOptionDTO readMeOptionDTO : readMeOptionDTOS) {
