...
import io.choerodon.test.manager.infra.common.utils.DateUtil;
...
=======
    ...
    public TestCycleE cloneFolder(TestCycleE protoTestCycleE, TestCycleE newTestCycleE, Long projectId) {
        ...
        int differentDaysOldFolder = DateUtil.differentDaysByMillisecond(oldFolderFromDate, oldFolderToDate);

        Date parentFromDate = parentCycleES.get(0).getFromDate();
        Date parentToDate = parentCycleES.get(0).getToDate();
        int differentDaysParent = DateUtil.differentDaysByMillisecond(parentFromDate, parentToDate);
        ...
        if (differentDaysOldFolder > differentDaysParent) {
            ...
            protoTestCycleE.setToDate(DateUtil.increaseDaysOnDate(parentFromDate, differentDaysOldFolder));
        }
