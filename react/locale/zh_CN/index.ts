...
const zhCN = {
  ...
  report_chooseQuestion: '选择工作项',
  report_defectCount: '缺陷数',
  report_total: '总共',
  // 选择工作项侧边栏
  report_select_title: '选择工作项',

  report_select_content_description: '您可以选择任意工作项生成报表',
  report_select_allVersion: '所有版本',
  report_select_questionId: '测试工作项ID',
  ...
  cycle_createExecute_content_description: '您可以在目标版本创建多个测试执行，可以从工作项或已有执行创建。',
  cycle_createExecute_createFromQuestion: '从工作项添加',
  cycle_createExecute_createFromCycle: '从循环添加',
  cycle_createExecute_testQuestion: '测试工作项',
  ...
  issue_issueSort: '排序',
  issue_issueSortByName: '工作项名称',
  issue_issueSortByType: '工作项类型',
  issue_issueSortByPriority: '工作项优先级',
  issue_issueSortByStatus: '工作项状态',
  ...
  issue_create_content_description: '请在下面输入测试用例的详细信息，包含详细描述、人员信息、版本信息、进度预估、优先级等等。您可以通过丰富的任务描述帮助相关人员更快更全面的理解任务，同时更好的把控工作项进度。',
  ...
  // 拷贝issue
  issue_copy_title: '复制工作项{issueNum}',
  issue_copy_copySprint: '是否复制冲刺',
  issue_copy_copyLinkIssue: '是否复制关联任务',
  // 创建链接任务
  issue_create_link_title: '创建链接',
  issue_create_link_content_title: '对工作项创建链接',
  issue_create_link_content_description: '请在下面输入相关任务的基本信息，包括所要创建的关系（复制、阻塞、关联、破坏、被复制、被阻塞、被破坏等）以及所要关联的工作项（支持多选）。',
  issue_create_link_content_create_relation: '关系',
  issue_create_link_content_create_question: '工作项',
  // 登记工作日志
  issue_worklog_title: '登记工作日志',
  issue_worklog_content_title: '登记"{issueNum}"的工作日志',
  issue_worklog_content_description: '您可以在这里记录您的工作，花费的时间会在关联工作项中预估时间进行扣减，以便更精确地计算工作项进度和提升工作效率。',
  ...
  createBug_content_description: '请在下面输入工作项的详细信息，包含详细描述、人员信息、版本信息、进度预估、优先级等等。您可以通过丰富的任务描述帮助相关人员更快更全面的理解任务，同时更好的把控工作项进度。',
  createBug_field_issueType: '工作项类型',
  createBug_field_summary: '概要',
  createBug_field_summaryRequire: '概要为必输项',
  createBug_fielf_summaryPlaceHolder: '请输入工作项概要',
  ...
  'priority.default': '（默认）',
  'priority.delete.notice': '注意：将会从所有使用的测试用例中删除这个优先级。',
  'priority.delete.used.notice': '请你为受影响的测试用例选择一个新的优先级。',
  'priority.delete.used.tip.prefix': '当前有 ',
  'priority.delete.used.tip.suffix': ' 个测试用例正在使用此优先级。',
  'priority.disable.title': '停用优先级',
  'priority.disable.notice': '注意：停用后你的测试用例将无法选择到此优先级。',
